...
class IndividualEachPostClass extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      isOpen1: false,
...
const IndividualEachPost = (props) => {
  return <IndividualEachPostClass {...props} />
}

export default connect(null, {showLoading, hideLoading})(IndividualEachPost)