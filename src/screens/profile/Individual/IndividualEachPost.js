...
class IndividualEachPost extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      isOpen1: false,
                ...
                <TouchableOpacity
                  onPress={() => {
                    if (parsedLevel.id == commentUsers.id) {
                      ...
                      navigation.navigate('Other', {user: commentUsers})
                    }
                  }}>
                  <Text
                    style={{
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (parsedLevel.id == single.id) {
                    ...
                    navigation.navigate('Other', {user: single})
                  }
                }}>
                <Text
                  style={{
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (parsedLevel.id == ownerId) {
                          ...
                          navigation.navigate('Other', {user: ownerInfo})
                        }
                      }}>
                      <Text
                        style={{
...
const IndividualEachPostFunction = (props) => {
  return <IndividualEachPost {...props} />
}

export default connect(mapStateToProps, {showLoading, hideLoading})(
  IndividualEachPostFunction,
)
